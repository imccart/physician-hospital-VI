...
******************************************************************
** 2007
insheet using "${DATA_UPLOAD}HospitalData_2007.txt", comma clear
gen Year=2007
save temp_hcris_2007, replace


** 2008
insheet using "${DATA_UPLOAD}HospitalData_2008.txt", comma clear
gen Year=2008
save temp_hcris_2008, replace


** 2009
insheet using "${DATA_UPLOAD}HospitalData_2009.txt", comma clear
gen Year=2009
save temp_hcris_2009, replace


** 2010
insheet using "${DATA_UPLOAD}HospitalData_2010a.txt", comma clear
gen Year=2010
save temp_hcris_2010a, replace

insheet using "${DATA_UPLOAD}HospitalData_2010b.txt", comma clear
gen Year=2010
...
** 2011
insheet using "${DATA_UPLOAD}HospitalData_2011a.txt", comma clear
gen Year=2011
save temp_hcris_2011a, replace

insheet using "${DATA_UPLOAD}HospitalData_2011b.txt", comma clear
gen Year=2011
...
** 2012
insheet using "${DATA_UPLOAD}HospitalData_2012.txt", comma clear
gen Year=2012
save temp_hcris_2012, replace


** 2013
insheet using "${DATA_UPLOAD}HospitalData_2013.txt", comma clear
gen Year=2013
save temp_hcris_2013, replace


** 2014
insheet using "${DATA_UPLOAD}HospitalData_2014.txt", comma clear
gen Year=2014
save temp_hcris_2014, replace


** 2015
insheet using "${DATA_UPLOAD}HospitalData_2015.txt", comma clear
gen Year=2015
