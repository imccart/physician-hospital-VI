...
************************************
** 2007 data
insheet using "${DATA_UPLOAD}pubas07.csv", clear case
...
************************************
** 2008 data
insheet using "${DATA_UPLOAD}pubas08.csv", clear case
...
************************************
** 2009 data
insheet using "${DATA_UPLOAD}pubas09.csv", clear case
...
************************************
** 2010 data
insheet using "${DATA_UPLOAD}ASPUB10.csv", clear case
...
************************************
** 2011 data
insheet using "${DATA_UPLOAD}ASPUB11.csv", clear case
...
************************************
** 2012 data
insheet using "${DATA_UPLOAD}ASPUB12.csv", clear case
...
************************************
** 2013 data
insheet using "${DATA_UPLOAD}ASPUB13.csv", clear case
...
************************************
** 2014 data
insheet using "${DATA_UPLOAD}ASPUB14.csv", clear case
...
************************************
** 2015 data
insheet using "${DATA_UPLOAD}ASPUB15.csv", clear case
