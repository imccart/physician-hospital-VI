...
1. [Inpatient Stays](data-code/1-InpatientStays.sas). This code file creates a table of all inpatient stays in a given year, excluding hospital transfers and admissions initiated in the ED. The goal is to focus only on "planned" admissions or elective surgeries.
