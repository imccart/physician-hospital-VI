...
******************************************************************
** 2007 Data
insheet using "${DATA_IPPS}imppuf07_apr2007.csv", clear case
...
** 2008 Data
insheet using "${DATA_IPPS}imppuf08_103107.csv", clear case
rename ProviderNumber MCRNUM
rename TACMIV24 CMI 
rename CASETA24 Total_Cases
gen Adjusted_Cases=Total_Cases*CMI
...
** 2009 Data
insheet using "${DATA_IPPS}imppuf09_080929.csv", clear case
rename ProviderNumber MCRNUM
rename TACMIV26 CMI 
...
** 2010 Data
insheet using "${DATA_IPPS}FY_2010_Final_Rule_Impact_File_1.txt", clear
rename providernumber MCRNUM
rename tacmiv26 CMI 
rename caseta26 Total_Cases
gen Adjusted_Cases=Total_Cases*CMI
...
** 2011 Data
insheet using "${DATA_IPPS}FY_2011_Final_Rule-_IPPS_Impact_File_PUF_1.txt", clear
rename providernumber MCRNUM
rename tacmiv27 CMI 
...
** 2012 Data
insheet using "${DATA_IPPS}FY_2012_Final_Rule-_IPPS_Impact_File_PUF-August_15__2011_1.txt", clear
rename providernumber MCRNUM
rename tacmiv28 CMI 
...
** 2013 Data
insheet using "${DATA_IPPS}FY_2013_Final_Rule_CN_-_IPPS_Impact_File_PUF-March_2013.txt", clear
rename providernumber MCRNUM
rename tacmiv29 CMI 
...
** 2014 Data
insheet using "${DATA_IPPS}FY_2014_Final_Rule_IPPS_Impact_PUF.txt", clear
rename providernumber MCRNUM
rename tacmiv30 CMI 
...
** 2015 Data
insheet using "${DATA_IPPS}FY_2015_IPPS_Final_Rule_Impact_PUF__FR_data_.txt", clear
rename providernumber MCRNUM
rename tacmiv31 CMI 
