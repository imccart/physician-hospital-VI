...
******************************************************************
use "${DATA_ACS}ACS_DATA_2007.dta", clear
gen Year=2007
append using "${DATA_ACS}ACS_DATA_2008.dta"
replace Year=2008 if Year==.
append using "${DATA_ACS}ACS_DATA_2009.dta"
replace Year=2009 if Year==.
append using "${DATA_ACS}ACS_DATA_2010.dta"
replace Year=2010 if Year==.
append using "${DATA_ACS}ACS_DATA_2011.dta"
replace Year=2011 if Year==.
append using "${DATA_ACS}ACS_DATA_2012.dta"
replace Year=2012 if Year==.
append using "${DATA_ACS}ACS_DATA_2013.dta"
replace Year=2013 if Year==.
append using "${DATA_ACS}ACS_DATA_2014.dta"
replace Year=2014 if Year==.
append using "${DATA_ACS}ACS_DATA_2015.dta"
