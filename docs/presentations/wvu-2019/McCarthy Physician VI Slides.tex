...
\begin{frame}{Estimates by Public share}
    \begin{table}[htb!]
    \centering
    \centerline{
    \begin{tabular}{l|rr}
        Outcome & VI & $\times$ Public Share \\
        \hline\hline \onslide<2->{\vspace{-.1in}\\
            Total Medicare Payments   &      88.093        &      26.638    \\                      					
                                      &   (113.638)        &   (223.408)   	\onslide<3->{\\
            Total Hospital Costs 	  &     520.925***     &    -655.699**  \\                                					
                                      &   (165.879)        &   (324.061)   	\onslide<4->{\\
            Inpatient Hospital Costs  &     252.181*       &    -191.168   	\\
                                      &   (131.999)        &   (264.319)   	\onslide<5->{\\
            Inpatient Length of Stay  &       0.013        &      -0.062  	\\
                                      &     (0.045)        &     (0.089)   	\onslide<6->{\\
            Outpatient Hospital Costs &     -73.150   		 &      57.086    \\
	         						  &    (49.911)        &    (98.901)    }}}}}\\
        \hline
        \multicolumn{3}{l}{\footnotesize * p-value $<$0.1, ** p-value $<$0.05, *** p-value $<$0.01}
    \end{tabular}}
...
\begin{frame}{Results on Other Outcomes}
    ...
    \begin{tabular}{l|rr}
        ...
        Patient Procedures & -0.004  & (0.058)  \onslide<8->{\\
        Patient Payments   & -180.101 & (130.470)  }}}}}}}\\
        \hline
        \multicolumn{3}{l}{\footnotesize * p-value $<$0.1, ** p-value $<$0.05, *** p-value $<$0.01}
    \end{tabular}}
    \end{table}
...
\begin{frame}{Summary of Results}
    ...
    \only<4>{
        \metroset{block=fill}
        \begin{block}{Evidence of Hospital Influence}
           \begin{itemize}
                \item Inpatient increases coming from more procedures
                \item Effects larger for hospitals with higher share of commercial payers
            \end{itemize}
        \end{block}
    }
