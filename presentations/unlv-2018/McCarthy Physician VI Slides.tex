...
\date{University of Nevada, Las Vegas}
\author{Haizhen Lin \& \textbf{Ian McCarthy} \& Michael Richards}
\institute{December 7, 2018}
...
\begin{frame}{Outline}
    \begin{enumerate}
        \item<1-> Motivestimation
        \item<2-> Initial Results
        \item<3-> Event Study
        \item<4-> Instrumental Variables
        \item<5-> Other Outcomes
    \end{enumerate}
\end{frame}
...
\begin{frame}{Intuition}
    \begin{itemize}
        ...
        \item Physician agency is net of patient preference
    \end{itemize}
\end{frame}
...
\begin{frame}{Within-physician Variation in Payments}
    ...
    \only<3>{
        \begin{figure}
            \centering
            \includegraphics[height=2.5in,width=5in,keepaspectratio]{PhySave_Graph_DRG}
        \end{figure}
    }
\end{frame}
...
\begin{frame}{Estimated Effects of Vertical Integration}
    ...
    \begin{tabular}{l|rr}
        ...
        Total Medicare Payments & 108.293** & (43.335)  \onslide<3->{\\
        Total Hospital Costs & 235.404***  & (60.717) \onslide<4->{\\
        Inpatient Hospital Costs & 157.018*** & (49.787) \onslide<5->{\\
        Inpatient Length of Stay & -0.014 & (0.017) \onslide<6->{\\
        Outpatient Hospital Costs & -47.940*** & (18.892) }}}}}\\
        \hline
...
\begin{frame}{Effects on Components of Inpatient Stay}
    ...
    \begin{tabular}{l|rr}
        ...
        \hline\hline
        Charges for: & & \\
        \hspace{.1in} Medical Supplies & 32.969 & (30.076) \\
        \hspace{.1in} Operating Room & -7.492 & (23.023) \\
        \hspace{.1in} Anesthesia & 5.715 & (5.044) \\
        \hspace{.1in} Labs & 10.324 & (8.767) \\
        \hspace{.1in} Radiology & -3.843 & (6.035) \\
        \hspace{.1in} MRI & -0.207 & (1.355) \\
        \hline
        \multicolumn{3}{l}{* p-value $<$0.1, ** p-value $<$0.05, *** p-value $<$0.01}
    \end{tabular}}
    \end{table}
...
\begin{frame}{Effects on Components of Inpatient Stay}
    ...
    \begin{tabular}{l|rr}
        ...
        \hline\hline
        Counts of: & & \\
        \hspace{.1in} Private Days  & -0.003 & (0.012) \\
        \hspace{.1in} ICU Days  & 0.023* & (0.013) \\
        \hspace{.1in} Radiology   & -0.00 & (0.00) \\
        \hspace{.1in} Procedures  & 0.028*** & (0.009) \\
        \hline
        \multicolumn{3}{l}{* p-value $<$0.1, ** p-value $<$0.05, *** p-value $<$0.01}
    \end{tabular}}
    \end{table}
...
\begin{frame}{IV Results: Aggregate Outcomes}
    ...
    \begin{tabular}{l|rr}
        Outcome & Estimate & St. Error \\
        \hline\hline \onslide<2->{\vspace{-.1in}\\
        Total Medicare Payments & 1028.994** & (498.917)  \onslide<3->{\\
        Total Hospital Costs & 3238.716***  & (697.512) \onslide<4->{\\
        Inpatient Hospital Costs & 2922.754*** & (532.646) \onslide<5->{\\
        Inpatient Length of Stay &  0.322* & (0.181) \onslide<6->{\\
        Outpatient Hospital Costs & -240.470 & (200.800) }}}}}\\
        \hline
        \multicolumn{3}{l}{* p-value $<$0.1, ** p-value $<$0.05, *** p-value $<$0.01}
    \end{tabular}}
    \end{table}
...
\begin{frame}{IV Results: Components of Inpatient Stay}
    \vspace{0.5in}
    \begin{table}[htb!]
    \centering
    \centerline{
    \begin{tabular}{l|rr}
        ...
        \hline\hline
        Charges for: & & \\
        \hspace{.1in} Medical Supplies & 88.308 & (310.707) \\
        \hspace{.1in} Operating Room & 914.093*** & (237.412) \\
        \hspace{.1in} Anesthesia & 126.673*** & (48.727) \\
        \hspace{.1in} Labs & -5.867 & (110.491) \\
        \hspace{.1in} Radiology & -143.188** & (66.940) \\
        \hspace{.1in} MRI & -41.617*** & (15.833) \\
        \hline
        \multicolumn{3}{l}{* p-value $<$0.1, ** p-value $<$0.05, *** p-value $<$0.01}
    \end{tabular}}
    \end{table}
...
\begin{frame}{IV Results: Components of Inpatient Stay}
    ...
    \begin{tabular}{l|rr}
        ...
        \hline\hline
        Counts of: & & \\
        \hspace{.1in} Private Days  & -0.343** & (0.141) \\
        \hspace{.1in} ICU Days  & -0.060 & (0.155) \\
        \hspace{.1in} Radiology   & -0.054*** & (0.016) \\
        \hspace{.1in} Procedures  & 0.783*** & (0.096) \\
        \hline
        \multicolumn{3}{l}{* p-value $<$0.1, ** p-value $<$0.05, *** p-value $<$0.01}
    \end{tabular}}
    \end{table}
...
\begin{frame}{Results on Other Outcomes}
    ...
    \begin{tabular}{l|rr}
        ...
        Outcome & Estimate & St. Error \\
        \hline\hline \onslide<2->{\vspace{-.1in}\\
        Physician's inpatient share & 0.081*** & (0.003) \onslide<3->{\\
        Physician's outpatient share & 0.057***  & (0.003) \onslide<4->{\\
        Total patients & 7.079*** & (0.505) \onslide<5->{\\
        Inpatient procedures & 1.102*** & (0.161) \onslide<6->{\\
        Outpatient procedures & 10.069*** & (1.015) \onslide<7->{\\
        Patient Procedures & 0.056  & (0.179)  \onslide<8->{\\
        Patient Payments   & -373.713 & (293.133)  }}}}}}}\\
        \hline
        \multicolumn{3}{l}{* p-value $<$0.1, ** p-value $<$0.05, *** p-value $<$0.01}
    \end{tabular}}
    \end{table}
...
\begin{frame}{Summary of Results}
    \only<1>{
        ...
        \begin{block}{Effects per Patient}
            \begin{itemize}
                \item Increase in Medicare payments (\$110 to \$300) and hospital costs (\$235-\$500)
                \item Extrapolates to between \$77 and \$210 million in added Medicare payments from vertical integration
                \item Components of inpatient stays suggest more procedures per patient
            \end{itemize}
        \end{block}
    }
    ...
    \only<3>{
        ...
        \begin{block}{Effects on Total Patients and Allocation of Procedures}
           \begin{itemize}
                ...
                \item New procedures predominantly coming from outpatient side (10 to 1)
                \item Perhaps higher usage, lower intensity patient selection (but insignificant)
            \end{itemize}
        \end{block}
    }
